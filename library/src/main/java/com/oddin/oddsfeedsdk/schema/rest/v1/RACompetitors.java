 ...
 *       &lt;sequence>
 *         &lt;element name="competitor" type="{http://schemas.oddin.gg/v1}team" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "competitors", propOrder = {
    "competitor"
})
public class RACompetitors {

    protected List<RATeam> competitor;
     ...
     * 
     */
    public List<RATeam> getCompetitor() {
        if (competitor == null) {
            competitor = new ArrayList<RATeam>();
        }
